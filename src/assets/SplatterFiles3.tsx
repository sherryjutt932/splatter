export const SplatterFiles3 = () => {
  return (
    <svg
      className="h-auto w-[100vw] sm:w-[min(800px,50vw)] absolute left-[-20%] sm:left-[10%] bottom-0 -translate-x-[23%] translate-y-[55%]"
      width="1102"
      height="1056"
      viewBox="0 0 1102 1056"
      fill="none"
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="127"
            result="effect1_foregroundBlur_6_871"
          />
        </filter>
        <filter
          id="filter1_f_6_871"
        ...
        >
          <feFlood flood-opacity="0" result="BackgroundImageFix" />
          <feGaussianBlur in="BackgroundImageFix" stdDeviation="6.53459" />
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_6_871"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_backgroundBlur_6_871"
            result="shape"
          />
        </filter>
        <linearGradient
          id="paint0_linear_6_871"
          x1="681.401"
          y1="305.689"
          x2="850.734"
          y2="452.904"
